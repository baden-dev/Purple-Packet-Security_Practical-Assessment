...
function HardwareTable() {
  ...
  useEffect(() => {
    const filtered = hardware.filter(item => {
      ...
      const cores = item.ram && item.cpu.cores ? item.cpu.cores.toLocaleString() : '';
      return agentId.includes(searchInput.toLowerCase()) || cpuName.includes(searchInput.toLocaleLowerCase()) || cores.includes(searchInput);
    });
